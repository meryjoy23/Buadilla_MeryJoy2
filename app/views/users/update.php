...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        input[type="text"], input[type="email"] { width: 100%; max-width: 420px; padding: 12px 14px; border: 2px solid #d6eadf; border-radius: 8px; background: #fefefe; transition: border-color .3s ease, box-shadow .3s ease; }
        input[type="text"]:focus, input[type="email"]:focus { outline: none; border-color: #228b22; box-shadow: 0 0 0 3px rgba(34,139,34,.15); }
        ...
        .btn-primary { background: linear-gradient(135deg, #228b22 0%, #006400 100%); color: white; border-color: #006400; }
        .btn-primary:hover { background: linear-gradient(135deg, #006400 0%, #013220 100%); border-color: #013220; }
